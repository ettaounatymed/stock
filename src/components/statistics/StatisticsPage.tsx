...
export function StatisticsPage({ summary }: StatisticsPageProps) {
  return (
    <article className="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[
          { label: "In stock", value: summary.inStockCount, icon: "🟢" },
          { label: "Sold", value: summary.soldCount, icon: "✅" },
          ...
          <article key={item.label} className="rounded-3xl border border-white/10 bg-slate-950/60 p-5 shadow-lg shadow-black/20">
